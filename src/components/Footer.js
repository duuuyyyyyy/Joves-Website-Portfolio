      ...
      <div className="footer-content">
        <div className="footer-top-layout">
          ...
          <div className="footer-grid-right">
            ...
            <p className="footer-tagline">Building the web with human touch</p>
            <p className="version-mark">version 2026 ©</p>
          </div>
        </div>

        <div className="footer-bottom-notice">
          <p className="rights-reserved">© 2026 Carla Dulay Joves. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
